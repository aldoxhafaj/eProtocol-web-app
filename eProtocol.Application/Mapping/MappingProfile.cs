...
public sealed class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<Document, DocumentDto>()
            .ForCtorParam("AssignedToId", opt => opt.MapFrom(src => src.Assignments.FirstOrDefault() != null ? src.Assignments.FirstOrDefault()!.UserId : (Guid?)null))
            .ForCtorParam("AssignedToName", opt => opt.MapFrom(src => src.Assignments.FirstOrDefault() != null && src.Assignments.FirstOrDefault()!.User != null ? src.Assignments.FirstOrDefault()!.User.UserName : null))
